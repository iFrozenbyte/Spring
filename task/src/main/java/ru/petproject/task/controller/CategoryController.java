...
import ru.petproject.entity.entities.Category;
import ru.petproject.task.search.CategorySearchValues;
import ru.petproject.task.service.CategoryService;
...
@RestController
@RequestMapping("/category") // /category/test
